...
import { AcuerdosPagoPage } from '@/features/acuerdos/AcuerdosPagoPage';
import { ConfiguracionNormativaPage } from '@/features/admin/ConfiguracionNormativaPage';
